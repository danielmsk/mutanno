...
def test_fullannot_run():
    ...
    for n1 in [10]:
        for r1 in range(1, 6):
            ...
            # vcf = "/Users/pcaso/work/mutanno_test/GAPFI3JX5D2J.vcf.gz"
            ...
            sourcefile = "/home/mk446/mutanno/DATASOURCE/MUTANOANNOT/v0.4.6_wbfilter_split/BGZIP_OLD/new/merged.mti.gz"
