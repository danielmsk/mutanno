...
# 0.3.4 : change type of `dbNSFP SiPhy_29way_pi` to list
# 0.3.5 : merge some dbNSFP fields into transcript table (dbNSFPTranscript)
# 0.3.6 : add makedata
# 0.3.7 : update annot module
# 0.3.8 (2020.02.25) : debugged first variant missing in annot module
# 0.3.9 (2020.02.26) :
